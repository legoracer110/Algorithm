...
public class SWEA4012_요리사 {
	...
	static void calcScore(int[] cook1, int[] cook2) {
		...
		for (int i = 0; i < N / 2; i++) {
			for (int j = 0; j < N / 2; j++) {
				score1 += synergy[cook1[i]][cook1[j]];
				score2 += synergy[cook2[i]][cook2[j]];
			}
		}
